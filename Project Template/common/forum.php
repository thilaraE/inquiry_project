            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="hide" id="myForm">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <form id="questionForm" class="user" method="post" action="submitQuestion.php" >
                        ...
                        if(!$conn){
                            ...
                            if(!$result){
                                ...
                                while($row=mysqli_fetch_assoc($result)){
                                    if($row["answer"]==null){
                                        echo "<div class=\"card shadow mb-4\"><div class=\"card-header py-3\"><h6 class=\"m-0 font-weight-bold text-primary\">",$row["question"],"</h6><small>Student ID:",$row["asked_by"],"</small></br><small>Posted at: ",$row["asked_timestamp"],"</small></div><div class=\"card-body\"> <input class=\"form-control form-control-user\" id=\"answer\" placeholder=\"Answer\"></div> </div>";
                    ...
                    <div class="row" id="questionCards">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">What is the difference between a chemical change and a physical change?</h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">What is the greenhouse effect?</h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">What is the difference between an acid and a base?</h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <input class="form-control form-control-user" id="answer"
                                        placeholder="Answer">
                            </div>
                        </div>
