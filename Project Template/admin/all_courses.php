                    ...
                    if (!$conn) {
                        ...
                        if(!$result){
                            ...
                            while($row=mysqli_fetch_assoc($result)){
                                    echo "<div class=\"col-lg-6 mb-4\"><div class=\"card bg-primary text-white shadow\"><div class=\"card-body\">",$row["subject"],"<div class=\"text-white-50 small\">Fee: ",$row["fee"],"</div>";
